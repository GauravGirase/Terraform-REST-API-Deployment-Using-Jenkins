...
resource "aws_route_table_association" "dev_proj_1_public_route_table_subnet-association" {
...
resource "aws_route_table_association" "dev_proj_1_private_route_table_subnet" {
